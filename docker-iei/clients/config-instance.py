...
spec:
  predictor:
    ...
    minReplicas: 1
    containers:
    - image: 100.60.131.23:5000/inais/ollama:0.5.1-minicpmv-2.6
      imagePullPolicy: Always
      name: kserve-container
      ports:
      - containerPort: 11434
...
spec:
  predictor:
    ...
    minReplicas: 1
    containers:
    - image: 100.60.131.23:5000/inais/ollama:0.3.14
      imagePullPolicy: Always
      name: kserve-container
      ports:
      - containerPort: 11434
...
spec:
  predictor:
    ...
    model:
      env:
      - name: MODEL_CONFIG
        value: /mnt/inaisfs/loki/bussiness/{}
      ...
      - name: pdf_parser_model_path
        value: "/mnt/inaisfs/loki/bussiness/custom-models"
      ...
      resources:
        ...
        requests:
          ...
          memory: 16G
      runtime: llmserver
      storageUri: hostpath:///mnt/inaisfs/loki/bussiness
""" 
